  ...
  return (
    <>
      <div className=" h-full flex flex-col justify-center items-center gap-5">
        <h2 className="text-5xl font-bold text-gray-800">About</h2>
        ...
        <div className="flex flex-row gap-5 mt-5">
          <img
            className="w-[569px] h-[300px] rounded-lg"
            src=".\src\assets\img\hero-bcg.1486d4061cd0252b9a21.jpeg"
            alt=""
          />
          <div className="flex flex-col">
            <div className="bg-white w-[570px] h-[300px] rounded-lg ">
              <div className="flex flex-row justify-around">
                ...
                <button
                  ...
                  className="${goals?} cursor-pointer tracking-[4px] w-[260px]  text-[20px] bg-[#dae2ec] focus:bg-white transition-all duration-500 hover:bg-blue-100 hover:text-blue-400"
                >
                  goals
                </button>
              </div>
